...
//
//void drawTriangle(double* vertex1, double* vertex2, double* vertex3) 
//{
...
//}
//
//void drawCircle(double* center, double radius) 
//{    
//	double delta_v = 0.01;
//	glColor3f(0, 1, 1.5);
//    glBegin(GL_POINTS);
...
//void draw(void) 
//{
//	double tvertex1[3] = {0.5, 0.5, 0.0};
//	double tvertex2[3] = {0.5, 0.9, 0.0};
//	double tvertex3[3] = {0.1, 0.6, 0.0};
//	
//	drawTriangle(tvertex1, tvertex2, tvertex3);
//	
...
//	glutCreateWindow("Duong tron ngoai tiep");	
//	init();	
